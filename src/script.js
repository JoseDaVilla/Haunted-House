...
//todo          Bushes
const bushGeometry = new THREE.SphereGeometry(1, 5, 5)
...
const ghost1 = new THREE.PointLight('#7FA68C', 2, 3)
scene.add(ghost1)

const ghost2 = new THREE.PointLight('#45214A', 2, 3)
scene.add(ghost2)

const ghost3 = new THREE.PointLight('#192B38', 2, 3)
scene.add(ghost3)
...
const tick = () => {
    ...
    ghost2.position.z = Math.sin(ghost2Angle) * (7 + Math.sin(elapsedTime * 0.5))
    ghost2.position.y = Math.sin(elapsedTime * 3)

    const ghost3Angle = - elapsedTime * 0.70
